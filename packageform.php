...
<div class="container">
    ...
    <!-- END nav -->
<br>
    <h1><b><i><u>Purchase form!!!!</u></i></b></h1>
    <br>
...
<b><i>Customer Name: </i></b><br />
<input name="name" type="text" maxlength="100" style="width:550px" />
</td>
</tr>
<tr>
<td colspan="2" style="width:50%; font-size:20px; color:Black">
<b><i>Email ID: </i></b><br />
<input name="email" type="text" maxlength="100" style="width:550px" />
</td>
</tr>
<tr>
<td colspan="2" style="width:50%; font-size:20px; color:Black">
<b><i>Package names: </i></b><br />
<input name="Relocate" type="radio" value="Basic" checked="checked" /> Basic &nbsp; &nbsp; &nbsp;
<input name="Relocate" type="radio" value="stardard" /> stardard &nbsp; &nbsp; &nbsp;
<input name="Relocate" type="radio" value="premium" /> premium &nbsp; &nbsp; &nbsp;
<input name="Relocate" type="radio" value="extra" /> extra
</td>
</tr>
<tr>
<td style="width:50%; font-size:20px; color:Black">
<b><i>Credit card number:</i></b><br />
<input name="number" type="number" maxlength="50" style="width:260px" />
</td>
<td style="width:50%; font-size:20px; color:Black">
<b><i>credit card pin:</i></b><br />
<input name="pin" type="password" maxlength="50" style="width:260px" />
</td>
</tr>
</table>
<br />
<button type="button"><a href="buythanks.php">Buy now!!</a></button>
</div>
</br>
</br>
</form>
